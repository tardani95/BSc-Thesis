...
$this.stop();});UI.$win.on("resize load",UI.Utils.debounce(function(){$this.resize();if($this.fixFullscreen){$this.container.css('height',window.innerHeight);$this.slides.css('height',window.innerHeight);}},100));setTimeout(function(){$this.resize();jQuery('.aw-rbslider-preloaded-img').remove();jQuery('.aw-rbslider-container').addClass('aw-rbslider-container-after');},80);if(this.options.autoplay){this.start();}
setTimeout(function(){$this.lazyLoadImage();},2000);if(this.options.videoautoplay&&this.slides.eq(this.current).data('media')){this.playmedia(this.slides.eq(this.current).data('media'));}
