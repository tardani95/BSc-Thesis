...
\section{Eszköz (elektronikai és beágyazott szoftverének) tervezése és összeállítása}
    ...
    \subsection{Védődoboz tervezése, 3D-nyomtatással prototípus gyártása}
        ...
        \subsubsection{3D nyomtatás és az elkészült hardver}
            ...
            \begin{figure}[h!]
                \centering
                    \includegraphics[width=7.5cm]{resources/pcb_res/printed_case_ngen.png}
                    \includegraphics[width=7.5cm]{resources/pcb_res/printed_case_abs.png}
            ...
            \begin{figure}[h!]
                \centering
                    \includegraphics[width=7.5cm]{resources/pcb_res/printed_case_wtop_ngen.png}
                    \includegraphics[width=7.5cm]{resources/pcb_res/printed_case_wtop_abs.png}
