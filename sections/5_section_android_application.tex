...
% \newpage
    \subsection{Az elkészült alkalmazás funkciói és felhasználói kézikönyv}
        ...
        %\subsubsection{Hibaelhárítás}
            ...
            \begin{figure}[h!]
                \begin{floatrow}
                    \ffigbox{\includegraphics[width=4.6cm]{android_res/screen_pictures/wifi_err_01.png}}{\caption{Koppintson a csatlakozás gombra!}\label{fig:wifi_err_01}}
                    \ffigbox{\includegraphics[width=4.6cm]{android_res/screen_pictures/wifi_err_02.png}}{\caption{Majd a bekapcsolásra!}\label{fig:wifi_err_02}}
                \end{floatrow}
            \end{figure}
            \begin{figure}[!h]
                \centering
        ...
        \subsubsection{Led sor IP-címének a beállítása}
            ...
            \begin{enumerate}
                \item Navigációs menü előhozása
                    ...
                    \begin{figure}[!h]
                        \begin{floatrow}
                            \ffigbox{\includegraphics[width=4.6cm]{android_res/screen_pictures/nav_menu_01.png}}{\caption{A menü gombra való kattintással}\label{fig:onMenu1}}
                            \ffigbox{\includegraphics[width=4.6cm]{android_res/screen_pictures/nav_menu_02.png}}{\caption{˝Swipe gesture segítségével˝}\label{fig:onMenu2}}
                        \end{floatrow}
                    \end{figure}\\
                ...
                \item Helyi hálózati IP cím beállítása (\ref{fig:tap_local_ip}. és \ref{fig:set_local_ip}. ábrák)
                    \begin{figure}[h!]
                        \begin{floatrow}
                            \ffigbox{\includegraphics[width=4.6cm]{android_res/screen_pictures/tap_local_ip.png}}{\caption{Koppintson a helyi hálózati IP cím beállításra!}\label{fig:tap_local_ip}}
                            \ffigbox{\includegraphics[width=4.6cm]{android_res/screen_pictures/set_local_ip.png}}{\caption{Állítsa be az IP címet, majd koppintson
...
% \newpage            
        \subsubsection{Simple Color Picker mód} %https://github.com/LarsWerkman/HoloColorPicker
            ...
            \begin{figure}[h!]
                \begin{floatrow}
                    \ffigbox{\includegraphics[width=4.6cm]{android_res/screen_pictures/s_cp_01.png}}{\caption{A csúszkák mozgatásával változtathatjuk a megjelenítendő színt}\label{fig:s_cp_01}}
                    \ffigbox{\includegraphics[width=4.6cm]{android_res/screen_pictures/s_cp_02.png}}{\caption{Szín beállítását a gombra koppintással végezhetjük el}\label{fig:s_cp_02}}
                \end{floatrow}
            \end{figure}
            ...
            \begin{figure}[h!]
                \begin{floatrow}
                    \ffigbox{\includegraphics[width=4.6cm]{android_res/screen_pictures/s_cp_03.png}}{\caption{Automatikus színválasztás funkció bekapcsolása}\label{fig:s_cp_03}}
                    \ffigbox{\includegraphics[width=4.6cm]{android_res/screen_pictures/s_cp_04.png}}{\caption{Ezek után a csúszkákat mozgatva automatikusan változtatja a színt}\label{fig:s_cp_04}}
                \end{floatrow}
            \end{figure}
...
%  \newpage           
            \subsubsection{Helyi hálózati IP cím beállítása}
                \begin{figure}[h!]
                    \begin{floatrow}
                        \ffigbox{\includegraphics[width=4.6cm]{android_res/screen_pictures/tap_local_ip.png}}{\caption{Koppintson a helyi hálózati IP cím beállításra!}\label{fig:tap_local_ip2}}
                        \ffigbox{\includegraphics[width=4.6cm]{android_res/screen_pictures/set_local_ip.png}}{\caption{Állítsa be az IP címet, majd koppintson az Ok gombra!}\label{fig:set_local_ip2}}
                    \end{floatrow}
                \end{figure}
% \newpage            
...
%  \newpage           
            \subsubsection{Automata színbeállítás a Simple Color Picker módhoz}
                ...
                \begin{figure}[h!]
                \begin{floatrow}
                    \ffigbox{\includegraphics[width=4.6cm]{android_res/screen_pictures/s_cp_03.png}}{\caption{Automatikus színválasztás funkció bekapcsolása}\label{fig:s_cp_05}}
                    \ffigbox{\includegraphics[width=4.6cm]{android_res/screen_pictures/s_cp_04.png}}{\caption{Ezek után a csúszkákat mozgatva automatikusan változtatja a színt}\label{fig:s_cp_06}}
                \end{floatrow}
            \end{figure}
